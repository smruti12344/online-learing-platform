...
const LectureTab = () => {
        ...
        if (file) {
          ...
          try {
            ...
            if (res?.data?.success) {
              ...
              setUploadVideoInfo(videoData); // Update the state correctly
            ...
            setMediaProgress(false); // Stop showing progress bar
            setLoading(false);
          }
        }
      };
  ...
  const editLectureHandler = async () => {
    console.log("inside lecture tab",{ lectureTitle, uploadVideInfo, isFree, courseId, lectureId });
